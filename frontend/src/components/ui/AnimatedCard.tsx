...
const AnimatedCard = React.forwardRef<HTMLDivElement, AnimatedCardProps>(
  ({ className, hoverEffect = true, scaleOnHover = 1.02, children, ...props }, ref) => {
    const cardProps = hoverEffect
      ? {
          whileHover: { y: -5, scale: scaleOnHover, boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)' },
          whileTap: { scale: 0.98 },
