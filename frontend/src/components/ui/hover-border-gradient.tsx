...
>) {
  ...
  const rotateDirection = (currentDirection: Direction): Direction => {
    ...
    if (currentIndex === -1) {
      // If currentDirection is not found, just return the first direction
    ...
    // Ensure the index wraps properly
    nextIndex = ((nextIndex % directions.length) + directions.length) % directions.length;
