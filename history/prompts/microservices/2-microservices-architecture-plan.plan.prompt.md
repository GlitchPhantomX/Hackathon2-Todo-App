...
user: claude
command: /sp.plan
labels: ["microservices", "dapr", "event-driven", "architecture"]
links:
  ...
  pr: null
files_yaml:
  - specs/1-microservices/plan.md
  - specs/microservices/research.md
  - specs/microservices/data-model.md
  - specs/microservices/quickstart.md
  - specs/microservices/contracts/events.yaml
tests_yaml: []
---
